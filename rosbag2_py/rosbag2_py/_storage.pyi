...
class BagMetadata:
    ...
    version: int
    def __init__(self, version: typing.SupportsInt = ..., bag_size: typing.SupportsInt = ..., storage_identifier: str = ..., relative_file_paths: collections.abc.Sequence[str] = ..., files: collections.abc.Sequence[FileInformation] = ..., duration: object = ..., starting_time: object = ..., message_count: typing.SupportsInt = ..., topics_with_message_count: collections.abc.Sequence[TopicInformation] = ..., compression_format: str = ..., compression_mode: str = ..., custom_data: collections.abc.Mapping[str, str] = ..., ros_distro: str = ...) -> None: ...
...
class Duration:
    def __init__(self, seconds: typing.SupportsInt, nanoseconds: typing.SupportsInt) -> None: ...
...
class FileInformation:
    ...
    path: str
    starting_time: object
    def __init__(self, path: str, starting_time: object, duration: object, message_count: typing.SupportsInt) -> None: ...
...
class QoS:
    def __init__(self, history_depth: typing.SupportsInt) -> None: ...
    ...
    def keep_last(self, arg0: typing.SupportsInt) -> QoS: ...
...
class StorageFilter:
    ...
    topics: list[str]
    def __init__(self, topics: collections.abc.Sequence[str] = ..., services_events: collections.abc.Sequence[str] = ..., actions: collections.abc.Sequence[str] = ..., regex: str = ..., exclude_topics: collections.abc.Sequence[str] = ..., exclude_service_events: collections.abc.Sequence[str] = ..., exclude_actions: collections.abc.Sequence[str] = ..., regex_to_exclude: str = ...) -> None: ...
...
class StorageOptions:
    ...
    uri: str
    def __init__(self, uri: str, storage_id: str = ..., max_bagfile_size: typing.SupportsInt = ..., max_bagfile_duration: typing.SupportsInt = ..., max_bag_files: typing.SupportsInt = ..., max_cache_size: typing.SupportsInt = ..., max_cache_duration: typing.SupportsInt = ..., storage_preset_profile: str = ..., storage_config_uri: str = ..., snapshot_mode: bool = ..., start_time_ns: typing.SupportsInt = ..., end_time_ns: typing.SupportsInt = ..., custom_data: collections.abc.Mapping[str, str] = ...) -> None: ...

class TopicInformation:
    message_count: int
    topic_metadata: TopicMetadata
    def __init__(self, topic_metadata: TopicMetadata, message_count: typing.SupportsInt) -> None: ...
...
class TopicMetadata:
    ...
    def __init__(self, id: typing.SupportsInt, name: str, type: str, serialization_format: str, offered_qos_profiles: collections.abc.Sequence[QoS] = ..., type_description_hash: str = ...) -> None: ...
...
def to_rclcpp_qos_vector(arg0: str, arg1: typing.SupportsInt) -> list[QoS]: ...

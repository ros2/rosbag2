...
class LowFreeSpaceAction:
    __members__: ClassVar[dict] = ...  # read-only
    DELETE_OLDEST_FILES: ClassVar[LowFreeSpaceAction] = ...
    STOP: ClassVar[LowFreeSpaceAction] = ...
...
class StorageOptions:
    custom_data: Dict[str, str]
    end_time_ns: int
    low_free_space_action: LowFreeSpaceAction
    max_bag_files: int

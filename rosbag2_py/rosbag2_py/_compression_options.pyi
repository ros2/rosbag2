...
class CompressionOptions:
    ...
    def __init__(self, compression_format: str = ..., compression_mode: CompressionMode = ..., compression_queue_size: typing.SupportsInt = ..., compression_threads: typing.SupportsInt = ...) -> None: ...

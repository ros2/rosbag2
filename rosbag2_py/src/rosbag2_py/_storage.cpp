...
PYBIND11_MODULE(_storage, m) {
  ...
  m.attr("MAX_ALLOWED_FILE_SPLITS") = rosbag2_storage::max_allowed_file_splits;
  ...
  pybind11::enum_<rosbag2_storage::FileSuffixStyle>(m, "FileSuffixStyle")
  .value("Index", rosbag2_storage::FileSuffixStyle::Index)
  .value("Datetime", rosbag2_storage::FileSuffixStyle::Datetime);
  ...
  .def_readwrite(
    "max_bagfile_splits",
    &rosbag2_storage::StorageOptions::max_bagfile_splits)
  .def_readwrite(
    "max_cache_size",

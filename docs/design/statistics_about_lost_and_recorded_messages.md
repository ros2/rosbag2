...
### 1. DDS Transport Layer Messages Loss Tracking
   ...
   To facilitate functionality for gathering statistics about number messages lost on the DDS 
...
### 2. Recorder-Side Messages Loss Tracking
  ...
  To facilitate functionality for gathering statistics about number of messages lost on the Rosbag2
...
### 3. CLI Option for Statistics Update Rate
  ...
  topic with the rate not higher than specified.
   ...
   - It will be used to specify the maximum update rate in times per second at which the statistics
     will be published. The default value will be 1Hz. The value of 0 will disable the publishing
     of statistics.

...
struct MessageDefinition
{
  ...
  bool operator==(const rosbag2_storage::MessageDefinition & rhs) const
  {
    return topic_type == rhs.topic_type && encoding == rhs.encoding && encoded_message_definition == rhs.encoded_message_definition;
  }
};

...
TEST_F(MetadataFixture, test_writing_and_reading_yaml)
{
  ...
  metadata.topics_with_message_count.push_back({{"topic1", "type1", "rmw1", "qos_profile1"}, 100});
  metadata.topics_with_message_count.push_back({{"topic2", "type2", "rmw2", "qos_profile2"}, 200});

...
void SequentialCompressorWriter::init_metadata()
{
...
void SequentialCompressorWriter::open(
...
void SequentialCompressorWriter::reset()
{
...
void SequentialCompressorWriter::compress_last_file()
{
...
void SequentialCompressorWriter::compress_message(
...
bool SequentialCompressorWriter::should_split_bagfile() const
{
...
void SequentialCompressorWriter::finalize_metadata()
{

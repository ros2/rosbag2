...
TEST_F(FilesystemHelperFixture, zstd_compress_file_uri)
{
  ...
  // 27MiB file
  auto uri = rosbag2_storage::FilesystemHelper::concat({temporary_dir_path_, "file1.txt"});
  ...
  auto uncompressed_file_size = rosbag2_storage::FilesystemHelper::get_file_size(uri);
  auto compressed_file_size = rosbag2_storage::FilesystemHelper::get_file_size(compressed_uri);

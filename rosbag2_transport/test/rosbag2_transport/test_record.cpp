...
TEST_F(RecordIntegrationTestFixture, topic_qos_overrides)
{
  ...
  test_msgs::msg::Strings string_msg;
  string_msg.string_value = "string";
  const auto topic = "/string_topic";
  ...
  rosbag2_test_common::PublicationManager pub_manager;
  pub_manager.setup_publisher(topic, string_msg, num_msgs, profile1);
  pub_manager.setup_publisher(topic, string_msg, num_msgs, profile2);
